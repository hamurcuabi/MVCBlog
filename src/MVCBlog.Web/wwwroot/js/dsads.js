    ...
    root.getTitle = function() {
	  ...
	  root.share = {
        ...
        root.popup(url);
		  ...
		  'wp': function () {
			  var url = 'https://web.whatsapp.com/send?text=' + encodeURIComponent(root.options.url);
	  ...
	  function closest(elem, parent) {
		...
		***********************************************/
		...
		root.options = {
			...
			networks: 'Mailto,Twitter,Pinterest,Facebook,GooglePlus,Reddit,Delicious,Tapiture,StumbleUpon,Linkedin,Slashdot,Technorati,Posterous,Tumblr,GoogleBookmarks,Newsvine,Pingfm,Evernote,Friendfeed,Vkontakte,Odnoklassniki,Mailru,Wp'
		}
